...
My research focuses on \textbf{computer security} from a systems perspective. My work has spanned censorship resistance, Internet protocol security, and embedded systems security.
...
\section{\large Professional Service}
     ...
     \emph{Program committee member:}
          USENIX Workshop on Free and Open Communications on the Internet (FOCI) 2013, 2016.
...
\section{\large Teaching}
    ...
    \emph{ECEN 5032: Introduction to Computer Security} (2016)

    \emph{ECEN 5014: Computer Security and Privacy} (2016)
